...
convert_to_submit(result_csv='output_robert_wwm_large_epoch5_lr1_ml64_bs12/test_results.tsv',
                  result_file='robert_wwm_large_epoch5_lr1_ml64_bs12_all_cols_rule2_989.csv',
                  submit_file='robert_wwm_large_epoch5_lr1_ml64_bs12_rule2_989.csv',
                  rule=2, is_test=True)
exit()
